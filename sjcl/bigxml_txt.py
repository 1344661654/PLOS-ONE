...
if FLAG == 1:
    ##train
    seq_root = "D:\yolo\yolov7-main\data1\Image\DETRAC-train-data"#图片
    xml_root = "D:\yolo\yolov7-main\data1\Annotations\DETRAC-Train-Annotations-XML" #原始xml标注
    label_root = "sjcl/train_detrac_txt/" #新生成的标签保存目录
else:
    ##test
    seq_root = "D:\yolo\yolov7-main\data1\Image\DETRAC-test-data"#图片
    xml_root = "D:\yolo\yolov7-main\data1\Annotations\DETRAC-Test-Annotations-XML" #原始xml标注
    label_root = "sjcl/test_detrac_txt/" #新生成的标签保存目录
